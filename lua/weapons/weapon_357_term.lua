...
if SERVER then
	util.AddNetworkString("weapon_357_term.muzzleflash")
else
	killicon.AddFont("weapon_357_term","HL2MPTypeDeath",".",Color(255,80,0))
end
...
local sk357DamageCvar 	= GetConVar( "sk_plr_dmg_357" )
...
function SWEP:DoMuzzleFlash()
	if SERVER then
		net.Start("weapon_357_term.muzzleflash",true)
...
if CLIENT then
	net.Receive("weapon_357_term.muzzleflash",function(len)
