...
if SERVER then
	util.AddNetworkString("weapon_shotgun_term.muzzleflash")
else
	killicon.AddFont("weapon_shotgun_term","HL2MPTypeDeath","0",Color(255,80,0))
end
...
function SWEP:DoMuzzleFlash()
	if SERVER then
		net.Start("weapon_shotgun_term.muzzleflash",true)
...
if CLIENT then
	net.Receive("weapon_shotgun_term.muzzleflash",function(len)
