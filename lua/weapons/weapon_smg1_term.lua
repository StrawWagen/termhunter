...
if SERVER then
	util.AddNetworkString("weapon_smg1_term.muzzleflash")
else
	killicon.AddFont("weapon_smg1_term","HL2MPTypeDeath","/",Color(255,80,0))
end
...
function SWEP:DoMuzzleFlash()
	if SERVER then
		net.Start("weapon_smg1_term.muzzleflash",true)
...
if CLIENT then
	net.Receive("weapon_smg1_term.muzzleflash",function(len)
