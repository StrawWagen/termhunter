...
if SERVER then
	util.AddNetworkString("weapon_pistol_term.muzzleflash")
else
	killicon.AddFont("weapon_pistol_term","HL2MPTypeDeath","-",Color(255,80,0))
end
...
function SWEP:DoMuzzleFlash()
	if SERVER then
		net.Start("weapon_pistol_term.muzzleflash",true)
...
if CLIENT then
	net.Receive("weapon_pistol_term.muzzleflash",function(len)
...
function SWEP:GetNPCBurstSettings()
	return 5,7,math.Rand( 0.12, 0.14 )
end
